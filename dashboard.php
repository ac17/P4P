              ...
              <div class = "container-fluid" id="tab-3">  
                <?php
                  ...
                  while($row = mysql_fetch_array($result)){
                    ...
                    if ($counter === 1){
                      echo '<tr><td style="width:20%">'.$row['Time'].'</td><td style="width:10%"><a onclick = "register_popup(\''.$otherUser.'\', \''.$otherUsername.'\')" >'.$otherUsername.'</a></td><td style="width:60%">' . $userFrom . ': ' . $row['Conversation'] .'</td></tr>';  //$row['index'] the index here is a field name
                    }
                    $counter = $counter + 1;    
                  }
